...
const createDataSource = () => {
       const daily = 'sat'
        return {
              date: response?.teacher?.[0]?.sat?.[0]?.date,
              remark: response?.teacher?.[0]?.sat?.[0]?.remark,
              total: response?.teacher?.[0]?.sat?.[0]?.total, 
              tajweed: response?.teacher?.[0]?.sat?.[0]?.tajweed, 
              hifz: response?.teacher?.[0]?.sat?.[0]?.hifz,
              tajError: response?.teacher?.[0]?.sat?.[0]?.tajError, 
              hifzError: response?.teacher?.[0]?.sat?.[0]?.hifzError,
              toV: response?.teacher?.[0]?.sat?.[0]?.toV,
              fromV: response?.teacher?.[0]?.sat?.[0]?.fromV,
              chapter: response?.teacher?.[0]?.sat?.[0]?.chapter
        }  
